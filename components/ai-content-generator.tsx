    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Gunakan AI untuk membuat konten edukasi tentang hemat energi secara otomatis
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="topic"
              placeholder="Contoh: Tips menghemat listrik di rumah untuk keluarga Indonesia"
              value={topic}
