...
import { AlertCircle, Leaf, Wind, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="block md:hidden absolute top-0 left-0 right-0 h-64 bg-gradient-to-b from-emerald-800 via-emerald-700 to-emerald-600 rounded-b-[3rem] overflow-hidden">
        <div className="absolute inset-0 opacity-50">
          <Image src="https://www.omv.com/images/GvflD8YyeyxOOJFgPN1juD8YainJ-lH3HR5e-kVPCCk/c:4000:2250:fp:0.589:0.512/resize:fill-down:768:432/plain/local:///2024/06/9eb4fa9b-6881-65bd-c3e3-d8ca49a106e8/OMV_Energy_Green-Hydrogen_Wind-Turbine-Aerial-View-01_RGB_web.jpg@webp" 
          width={500}
          height={500}
          alt="Wind turbines aerial view"
          className="w-full h-full object-cover" />
        ...
        <div className="absolute top-8 left-8 opacity-20">
          <div className="w-32 h-32 bg-emerald-300 rounded-full blur-xl"></div>
        </div>
        <div className="absolute top-16 right-12 opacity-15">
          <div className="w-24 h-24 bg-emerald-200 rounded-full blur-lg"></div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-emerald-100 md:bg-white/95 md:backdrop-blur-sm md:shadow-2xl md:border-white/20">
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                {/* <Link href="/forgot-password" className="text-sm text-emerald-600 md:text-green-600 hover:underline font-medium">
                  Forgot Password?
                </Link> */}
              </div>
        ...
        <div className="min-h-screen flex items-center justify-center bg-white p-6">
          <div className="w-full max-w-sm">
            <div className="animate-pulse">
              <div className="bg-emerald-100 rounded-2xl shadow-lg p-6">
                <div className="h-8 bg-emerald-200 rounded mb-4"></div>
                <div className="h-4 bg-emerald-200 rounded mb-6"></div>
